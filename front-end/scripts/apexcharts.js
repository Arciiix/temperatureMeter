        ...
        a(t, [
          ...
          },
          {
            ...
            value: function(t, e) {
              ...
              if (
                (t.draggable &&
                  this.helpers.makeAnnotationDraggable(C, "texts", e),
                s)
              ) {
          ...
          },
          {
            ...
            value: function(t, e) {
              ...
              (s =
                ...
                a.globals.dom.elAnnotations.add(s);
            }
          },
          {
            key: "addImage",
        ...
        a(t, [
          {
            ...
            value: function(t) {
              ...
              for (
                ...
                v < r.globals.seriesXvalues.length;
                v++
              )
                b.push(
                  [r.globals.seriesXvalues[v][0] - 1e-6].concat(
                    r.globals.seriesXvalues[v]
                  )
                );
              return (
                (b = b.map(function(t) {
          ...
          },
          {
            ...
            value: function(t) {
              ...
              return (
                ...
                { pathTo: b, pathFrom: v, x: r, y: n, barYPosition: x }
              );
            }
          },
          {
            ...
            value: function(t) {
              ...
              if (
                ...
                var k = this.barOptions.colors.backgroundBarColors[f],
                  A = c.drawRect(
                    b - o / 2 - r * this.visibleI,
                    0,
                    r * this.seriesLen + o / 2,
          ...
          },
          {
            ...
            value: function(t) {
              ...
              for (var p, x = i, b = 0, v = 0; v < this.prevYF.length; v++)
                b += isNaN(this.prevYF[v][d]) ? 0 : this.prevYF[v][d];
              if (
                ...
                void 0 === m && (m = h.globals.gridHeight),
                  (p =
            ...
            value: function(t) {
              ...
              if (
                ...
                f.globals.hasNullValues
                  ...
                  (l = n),
                  s === e[i].length - 2 &&
                    ((c = c + x.curve(o, l, r, n, r, v) + x.move(r, n) + "z"),
                ...
                null === e[i][s] && ((h += x.move(r, n)), (c += x.move(r, v))),
                  "stepline" === b
        ...
        a(t, [
          {
            ...
            value: function() {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.exports = new N(this.ctx)),
